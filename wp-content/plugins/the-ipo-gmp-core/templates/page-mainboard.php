        ...
        <div class="flex flex-col sm:flex-row gap-4 w-full lg:w-auto">
            ...
            <div class="flex p-1 bg-slate-900 border border-border-navy rounded-lg">
                ...
                foreach ($tabs as $k => $v):
                    ...
                    ?>
                    <a href="<?php echo tigc_get_filter_url($k); ?>"
                ...
                <table class="w-full text-left border-collapse min-w-[600px]">
                    <thead>
                        <tr class="bg-[#0f172a] border-b border-border-navy">
                            <th class="px-6 py-4 text-[11px] font-black text-slate-500 uppercase tracking-widest">Company
                            </th>
                            <th class="px-6 py-4 text-[11px] font-black text-slate-500 uppercase tracking-widest">Price Band
                            </th>
                            <th
                            ...
                            <tr class="data-table-row transition-all cursor-pointer group <?php echo $row_status_class; ?>"
                                ...
                                <td class="px-6 py-4 hidden md:table-cell">
                                    <div class="flex flex-col">
                                        ...
                                        <span
                                            class="text-xs font-medium text-slate-200"><?php echo $ipo->listing_date ? date('M j', strtotime($ipo->listing_date)) : 'TBA'; ?></span>
                                    </div>
                                </td>
